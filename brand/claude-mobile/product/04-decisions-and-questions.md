...
### Legal & Brand
3. Does Anthropic have guidelines for third-party clients that dictate how prominently "Claude" can be used in integration and marketing materials?
...
|---|---|---|---|---|
| Canonical Name | Historical references include "Checkpoint", "Claude Mobile", and "claude-mobile-controller". | High | Adopt **MobileAgenticIDE** globally for product-facing naming. | APPROVED |
