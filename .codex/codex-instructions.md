...
This workspace generates **brand design systems** for arbitrary new projects/ideas. It is a Codex
...
Each brand subsystem has a dedicated skill (`.codex/skills/<name>`) and a numbered output folder.
