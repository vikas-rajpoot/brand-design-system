---
name: ai-ready-spec
description: 'Use when producing the structured, machine-readable brand-spec.json that aggregates the full brand system so any AI agent (Claude, Codex, Codex, etc.) can consume it consistently.'
---
