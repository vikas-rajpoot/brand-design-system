...
This workspace generates **brand design systems** for arbitrary new projects/ideas. It is a Claude
...
Each brand subsystem has a dedicated skill (`.claude/skills/<name>`) and a numbered output folder.
