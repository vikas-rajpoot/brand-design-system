...
Check `brand/${input:slug}` against the 21-folder map in `.claude/claude-instructions.md`:
...
- Any doc missing frontmatter (`status`, `version`) per `.claude/instructions/brand-docs.instructions.md`
